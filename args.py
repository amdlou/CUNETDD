...
def get_args() -> Dict[str, Any]:
    ...
    args: Dict[str, Any] = {
        ...
        'n_depth': 4,  # Set Number of convolutional layers in each block
        'dp_rate': 0.5,  # Set the dropout rate
        ...
        'num_workers': 0,  # Use the parsed num_workers

        # #### Trainer arguments#####
        'num_nodes': 1,  # Use the parsed num_nodes
