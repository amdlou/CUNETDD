...
def get_args() -> Dict[str, Any]:
    ...
    args: Dict[str, Any] = {
        ...
        'num_workers': 2,  # Set the number of workers for data loading


        # #### Trainer arguments#####

        'gpus': -1,  #[0,1],  # Set to None for CPU
        'strategy': 'ddp_find_unused_parameters_true',  # Set the strategy for distributed training
        'num_nodes': 5,  # Set the number of nodes
        ...
        'limit_train_batches' : 0.98,  # Set the fraction of training data to us
        ...
        'log_every_n_steps': 1,  # Set the number of steps between each log
        'check_val_every_n_epoch': 2,  # Set the frequency of validation
